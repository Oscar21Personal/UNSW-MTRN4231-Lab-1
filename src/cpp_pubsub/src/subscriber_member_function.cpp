...
public:
  ...
  : Node("minimal_subscriber")
  {
    ...
    //   "counter", 10, std::bind(&MinimalSubscriber::topic_callback, this, _1));
...
private:
  void topic_callback(const geometry_msgs::msg::Pose & msg) const
  {
    ...
    RCLCPP_INFO(this->get_logger(), "I heard pose: %f, %f, %f", msg.position.x, msg.position.y, msg.position.z);
  }
