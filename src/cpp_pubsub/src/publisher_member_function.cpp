...
private:
  void timer_callback()
  {
    ...
    // Publish integers
    // msg.data++;
    // RCLCPP_INFO(this->get_logger(), "Publishing counter: %ld", msg.data);
    ...
    msg.position.y = 1.0;
    msg.position.z = 2.0;
    RCLCPP_INFO(this->get_logger(), "Publishing pose: %f, %f, %f", msg.position.x, msg.position.y, msg.position.z);
    publisher_->publish(msg);
  }
